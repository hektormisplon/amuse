                  ...
                  <TableRow key={post.id}>
                    ...
                    <TableCell>
                      ...
                      <IconButton
                        ...
                        style={{ opacity: post.deleted_at ? 0.3 : 1 }}
                      >
                        <IconDelete />
                      </IconButton>
                      <IconButton
                        onClick={() =>
                          this.handleDialogOpen(post.id, POSTACTIONSENUM.DELETE)
                        }
                      >
                        <IconDeleteForever />
                      </IconButton>
