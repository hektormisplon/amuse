  ...
  handleDialogOpen = (museumId, museumAction) => {
    ...
    switch (museumAction) {
      case POSTACTIONSENUM.DELETE:
        ...
        message = `Permenantly delete this museum? ${museumId}`;
        break;
      case POSTACTIONSENUM.SOFTDELETE:
        title = "Soft delete from database";
        message = `Soft-delete this museum? ${museumId}?`;
        break;
      case POSTACTIONSENUM.SOFTUNDELETE:
        title = "Soft-undelete from database";
        message = `Soft-undelete this museum? ${museumId}?`;
        break;
      default:
        break;
    }
                      ...
                      <IconButton
                        onClick={() =>
                          this.handleDialogOpen(
                            museum.id,
                            museum.deleted_at
                              ? POSTACTIONSENUM.SOFTUNDELETE
                              : POSTACTIONSENUM.SOFTDELETE
                          )
                        }
                        style={{ opacity: museum.deleted_at ? 0.3 : 1 }}
                      >
                        <IconDelete />
                      </IconButton>
                      <IconButton
